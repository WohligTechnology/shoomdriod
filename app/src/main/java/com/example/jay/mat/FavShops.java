...
public class FavShops extends ActionBarActivity implements NavigationDrawerCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_shops);
        ...
        tvHome.setText("Favourite Shops");
